...
public class Train {
    ...
    public void train() {
        String path = "E:\\licenta\\GermaNet\\src\\main\\java\\type2\\seedsFiles\\3labels\\multipleSeeds\\verbsDepth4";
    ...
    public void trainDT() {
        String path = "E:\\licenta\\GermaNet\\src\\main\\java\\type2\\seedsFiles\\3labels\\multipleSeeds\\withoutNegLabels\\multipleIniSeedsVerbsDepth4";
    ...
    public void trainMPC() {
        ...
        // Load training data
        transformLabelToOnlyPositive("E:\\licenta\\GermaNet\\src\\main\\java\\type2\\seedsFiles\\3labels\\multipleSeeds\\verbsDepth4");
        String path = "E:\\licenta\\GermaNet\\src\\main\\java\\type2\\seedsFiles\\3labels\\multipleSeeds\\withoutNegLabels\\multipleIniSeedsVerbsDepth4";
        ...
        for (Double split : splitBy) {
            ...
            Dataset<Row> predictionsTrain = model.transform(train).select("prediction", "label");
    ...
    public Integer getHighestIndex(String path) {
        Integer highest = 0;
        try {
            ...
            while ((st = br.readLine()) != null){
                ...
                for (Integer index=1; index<= splitted.length; index++) {
                    String[] splitAgain = splitted[index].split(":");
                    if (Integer.parseInt(splitAgain[0]) > highest) {
                        highest = Integer.parseInt(splitAgain[0]);
                    }
                }
            }
    ...
    public void transformLabelToOnlyPositive(String path) {
        ...
        try {
            File statText = new File("E:\\licenta\\GermaNet\\src\\main\\java\\type2\\seedsFiles\\3labels\\multipleSeeds\\withoutNegLabels\\multipleIniSeedsVerbsDepth4");
